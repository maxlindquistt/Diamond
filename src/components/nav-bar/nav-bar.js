...
<nav>
  <ul>
    <custom-button text = "Startsida" href = "../index.html"></custom-button>
    <custom-button text ="Tjänster" href = "../views/services.html"></custom-button>
    <custom-button text ="Om oss" href = "../views/om.html"></custom-button>
    <custom-button text ="Kontakt" href = "../views/kontakt.html"></custom-button>
  </ul>
</nav>
